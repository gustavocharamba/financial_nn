...
def backtesting_with_yfinance():
    ...
    feature_cols = [
        ...
        'Stoch_K', 'Stoch_D'
        # Adicione extras se usados no treino!
    ]
    ...
    # ==== Estratégia: Stop Gain e Stop Loss ====
    start_balance = 10000.0
    position_size = 1000.0
    fee_pct = 0.001
    target_profit_pct = 0.1   # 5% de alvo de ganho
    stop_loss_pct = 0.035   # 3.5% de stop loss
    ...
    for i, row in df_features.iterrows():
        ...
        # VENDA: por stop gain ou stop loss, ignora sinal do modelo
        if in_trade:
        ...
        # COMPRA: só por sinal do modelo e se não está comprado
    ...
    plt.title('Preço BTC com pontos de Compra e Venda (stop gain/stop loss)')
    plt.xlabel('Data')
