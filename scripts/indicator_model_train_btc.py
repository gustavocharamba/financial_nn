...
from classifications.class_bitcoin_indicators import btc_classification_indicators

# --- Carregar e preparar dados ---
df = load_indicators_datasets("BTC")
df = btc_classification_indicators(df)
...
# --- Parâmetros ---
window_size = 400  # ~3 meses de dados para treino
step_size = 40     # avanço da janela para folds
min_test_size = 30 # tamanho mínimo do teste
...
for k in range(n_folds):
    ...
    auc = roc_auc_score(y_test, y_pred_probs.flatten()) if len(np.unique(y_test)) > 1 else 0.6
